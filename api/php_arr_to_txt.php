...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (empty($user_path)) {
		die("Plase input your php file address such as".PHP_EOL."https://www.123.xyz/1.php?id=");
	} else if (empty($arr_data)) {
		die("Plase input your php array such as".PHP_EOL."'cctv1' => 'CCTV1SD_1200', //CCTV1");
	}
	$pattern = "/.*['\"](\w+)['\"].*=.+\/\/(.+)/";
